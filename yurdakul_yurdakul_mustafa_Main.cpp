...
#include <fstream>
#include <sstream>
#include "yurdakul_yurdakul_mustafa_board.h" //change this with your board header file name
#include "yurdakul_yurdakul_mustafa_player.h" //change this with your player header file name
